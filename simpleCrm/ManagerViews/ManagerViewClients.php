...
if (isset($_POST['search_clients'])){
    ...
    header("Location:http://localhost/simpleCrm/MnewClient.php");
} else if (isset($_POST['submitUpdate'])){
    unset($_POST['submitUpdate']);
    header("Location:http://localhost/simpleCrm/MupdateClient.php");
} else if (isset($_POST['submitUpdateRe'])){
    unset($_POST['submitUpdateRe']);
    header("Location:http://localhost/simpleCrm/MreassignClient.php");
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="col-sm-10">
                ...
                <form action="ManagerViewClients.php" class="form-inline" method = "post">
                ...
                <form action= "ManagerViewClients.php" method = "post">
                    ...
                    <input type="submit" class="btn btn-success" name = "submitUpdateRe" value = "Reassign Client">
                </form>
            </div>
        </div>
