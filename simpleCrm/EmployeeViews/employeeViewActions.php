...
if (isset($_POST['search_action'])){
    ...
    if($attr == "completed"){
        ...
        $searchClause = " AND  $attr = '$searchKey' ";
    } else {
    ...
    <body>
        <nav>
            <ul>
                ...
                <li><a href="http://localhost/simpleCrm/EmployeeViews/employeeViewClients.php">Clients</a></li> <li><a href="http://localhost/simpleCrm/EmployeeViews/employeeViewActions.php">Actions</a></li> 
        ...
        <div class="container">
            <div class="col-sm-10">
                ...
                <form action="employeeViewActions.php" class="form-inline" method = "post">
                ...
                <form action="http://localhost/simpleCrm/updateAction.php" method = "post">
